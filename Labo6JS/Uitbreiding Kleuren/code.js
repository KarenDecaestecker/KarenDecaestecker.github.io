...
btnSave.addEventListener("click", () =>{
	...
	let savedVierkant = document.createElement("div");
	savedVierkant.classList.add("savedVierkant");
	savedVierkant.style.backgroundColor = color;

	let deleteBtn = document.createElement("button");
	deleteBtn.classList.add("delete");
	deleteBtn.textContent = "X";
	deleteBtn.addEventListener("click", () =>{
		savedVierkant.remove();
	});

	savedVierkant.appendChild(deleteBtn);
	savedVierkant.appendChild(savedVierkant);
